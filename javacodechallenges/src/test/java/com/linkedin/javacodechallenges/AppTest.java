...
public class AppTest {
        ...
        public void redactTextFile_ensureRedaction() {
                ...
                try {
                        ...
                        redactedFile = new File("Redacted_sample.txt");
        ...
        public void redactTextFile_wrongFileType() {
                ...
                App.redactTextFile("sample.jpg",
                                new String[] { "sally", "Kat", "ready to go" });
                File tempFile = new File("Redacted_sample.jpg");
        ...
        @Test
        public void redactTextFile_fileDoesNotExist() {

                App.redactTextFile("randomName.txt",
                                new String[] { "sally", "Kat", "ready to go" });
                File tempFile = new File("Redacted_randomName.txt");
                assertFalse(tempFile.exists());
                assertEquals("That file doesn't exist or isn't valid.\n",
                                printOut.toString());
        }

        @Test
        public void redactTextFile_fileIsDirectory() {

                App.redactTextFile("thisIsAFolder.txt",
                                new String[] { "sally", "Kat", "ready to go" });
                File tempFile = new File("Redacted_thisIsAFolder.txt");
                assertFalse(tempFile.exists());
                assertEquals("That file doesn't exist or isn't valid.\n",
                                printOut.toString());
        }
